...
public class AppController {
	...
	public String saveuser(@ModelAttribute ("user") User user,@RequestParam("role") String role,Model m,HttpSession session)
	{
		...
		ur.setUser_id(u.getId());
			...
			Role rr = roleService.getRoleByName(role);
			
		ur.setRole_id(rr.getId());
		users_rolesService.addUsers_roles(ur);
