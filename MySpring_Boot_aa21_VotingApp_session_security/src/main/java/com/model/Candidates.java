...
public class Candidates {
	...
	public Candidates(int id, String candidate1, String candidate2, String candidate3, String candidate4) {
		super();
		this.id = id;
	...
	public String toString() {
		return "Candidates [id=" + id + ", candidate1=" + candidate1 + ", candidate2=" + candidate2 + ", candidate3="
