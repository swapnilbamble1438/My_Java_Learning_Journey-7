...
public class StudentController {
	 ...
	 * means applying security to specific controller handler
	 
	 Now try to add new student
	 Open Postman app 
	 use POST method 
	 use url:  http://localhost:8080/students
	 Body--> raw-->JSON
	...
	*/
	...
	@PreAuthorize("hasRole('ADMIN')")  // means it will only access by admin
